...
const handleGenBioClicked = async () => {
  ...
  return (
    <section className="flex flex-col h-screen overflow-hidden bg-gradient-to-b from-gray-900 to-gray-800 text-white">
    <Navbar isAuthenticated={true} />
    
    {/* Fixed Header */}
    <header className="flex-shrink-0  pt-0 pb-2 sm:pt-6 sm:pb-4">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-5xl mx-auto"></div>
          ...
          <div className="bg-gray-800/50 rounded-3xl p-4 sm:p-8 backdrop-blur-sm border border-gray-700 shadow-xl">
            {/* Profile Header */}
            <header className="flex items-center space-x-4 sm:space-x-6 mb-6 sm:mb-8 pb-6 sm:pb-8 border-b border-gray-700">
