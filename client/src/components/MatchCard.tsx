...
>
    ...
    {match.image ? (
      ...
      <div className="w-10 h-10 sm:w-16 sm:h-16 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-xl sm:text-2xl font-bold mx-auto sm:mx-0">
        {match.name[0]}{match.name[1] ? match.name[1] : ''}
      </div>
    )}
